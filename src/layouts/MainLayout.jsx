...
const roleMenus = {
  GVU: [
    ...
    },
    {
      ...
      icon: <ToolOutlined />,
      label: <Link to="/calendar-management">Quản lý Lịch</Link>,
    },
    {
      key: "/credit-class-management",
      icon: <SolutionOutlined />,
      label: <Link to="/credit-class-management">Quản lý Lớp tín chỉ</Link>,
    },
    {
      key: "/request-management",
      icon: <FileDoneOutlined />,
      label: <Link to="/request-management">Quản lý Yêu cầu</Link>,
    },
    {
      key: "/calendar",
      icon: <CalendarOutlined />,
      label: <Link to="/calendar">Xem Lịch Biểu</Link>,
    },
    {
      key: "/reports/calendar",
      icon: <BarChartOutlined />,
      label: <Link to="/reports/calendar">Báo cáo Lịch</Link>,
    },
    {
      key: "/teaching-schedules",
      icon: <ScheduleOutlined />,
      label: <Link to="/teaching-schedules">Lịch Giảng Dạy</Link>,
    },
  ],
  CSVC: [
    {
    ...
    },
    {
      ...
      label: <Link to="/room-management">Quản lý Phòng máy</Link>,
    },
    {
      key: "/request-management",
      icon: <FileDoneOutlined />,
    ...
    },
    {
      key: "/reports/room",
      icon: <BarChartOutlined />,
      label: <Link to="/reports/room">Báo cáo Phòng máy</Link>,
    },
  ],
  GV: [
    {
    ...
    },
    {
      key: "/calendar",
      icon: <CalendarOutlined />,
      label: <Link to="/calendar">Lịch thực hành</Link>,
    },
    {
      key: "/my-requests",
    ...
    {
      key: "/my-teaching-schedule",
      icon: <ScheduleOutlined />,
      label: <Link to="/my-teaching-schedule">Lịch Giảng Dạy Của Tôi</Link>,
    },
  ],
  TK: [
    {
...
const MainLayout = () => {
  ...
  const avatarUrl =
    user && user.avatar ? `http://localhost:8080/avatars/${user.avatar}` : null;
  ...
  return (
    <Layout style={{ minHeight: "100vh" }}>
      ...
      >
        <div className="logo-vertical slide-in">{collapsed ? "P" : "PTIT"}</div>
        <Menu
          theme="dark"
